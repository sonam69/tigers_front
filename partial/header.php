<header>
    <div class="container">
        <a id="logo" href="/" class="fadeIn delay2000ms">Hollywood Tigers</a>
        <div class="menu_nav">
            <button class="close" onclick="(toggle_menu(false))" style="right: 17px;"></button>
            <ul class="navigation">
                <li class="fadeInUp delay2200ms"><a href="/">Home</a></li>
                <!-- <li><a onclick="moveTo('.banner')">About</a></li>
                <li><a onclick="moveTo('.meet')">Team</a></li>
                <li><a href="whitepaper">White Paper</a></li>
                <li><a onclick="moveTo('.roadmap')">Road Map</a></li> -->
                <li class="fadeInUp delay2400ms"><a href="/#banner">About</a></li>
                <li class="fadeInUp delay2600ms"><a href="/#meet">Team</a></li>
                <li class="fadeInUp delay2800ms"><a href="whitepaper">White Paper</a></li>
                <li class="fadeInUp delay3000ms"><a href="/#roadmap">Road Map</a></li>
            </ul>
        </div>
